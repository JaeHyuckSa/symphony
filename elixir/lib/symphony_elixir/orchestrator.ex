defmodule SymphonyElixir.Orchestrator do
  ...
  defp integrate_agent_update(running_entry, %{event: event, timestamp: timestamp} = update) do
    ...
    current_input_tokens = Map.get(running_entry, :agent_input_tokens, 0)
    current_output_tokens = Map.get(running_entry, :agent_output_tokens, 0)
    current_total_tokens = Map.get(running_entry, :agent_total_tokens, 0)
    current_agent_pid = Map.get(running_entry, :agent_pid)
...

    {
      Map.merge(running_entry, %{
        ...
        agent_pid: agent_pid_for_update(current_agent_pid, update),
        agent_input_tokens: current_input_tokens + token_delta.input_tokens,
        agent_output_tokens: current_output_tokens + token_delta.output_tokens,
        agent_total_tokens: current_total_tokens + token_delta.total_tokens,
  ...
  defp record_session_completion_totals(state, running_entry) when is_map(running_entry) do
    ...
    %{state | agent_totals: updated_totals}
  end
